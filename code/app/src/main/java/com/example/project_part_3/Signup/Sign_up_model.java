...
public class Sign_up_model {
    ...
    public Sign_up_model(String name, String password, String email, String phone, ArrayList<String> interest, String usertype) {
        FirebaseFirestore firebaseFirestore = FirebaseFirestore.getInstance();
        this.db = new Database(firebaseFirestore);

        switch (usertype) {
            case "Entrant":
                this.user = new Entrant(name, password, email, phone, interest);
                break;
            case "Organizer":
